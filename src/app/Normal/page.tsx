...
const Normal: React.FC = () => {
  ...
  const resetGame = () => {
    ...
    setGameOver(false);
    setBoxContent(generateBoxContent());
    handleClick('/Normal', 25); // Example of calling handleClick with route and cost
  };
    ...
    <div>
      ...
      {(currentFloor === 8 && !gameOver) && (
        <div>
          ...
          <button onClick={resetGame} disabled={points < 25} className="bg-blue-500 text-white py-2 px-4 rounded hover:bg-blue-600">Play Again</button>
